 ...
 */
add_shortcode('growtype_wc_featured_coupon_discount', 'growtype_featured_coupon_discount');
 ...
 * Woocommerce coupon discount
 */
add_shortcode('growtype_wc_featured_coupon_code', 'growtype_featured_coupon_code');
