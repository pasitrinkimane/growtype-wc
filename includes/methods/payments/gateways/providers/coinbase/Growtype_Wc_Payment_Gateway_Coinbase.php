...
/**
 * Class Growtype_Wc_Payment_Gateway_Coinbase
 * Payment method for Coinbase Commerce
 */
class Growtype_Wc_Payment_Gateway_Coinbase extends WC_Payment_Gateway
{
    ...
    protected function setup_properties()
    {
        ...
        $this->icon = apply_filters('growtype_wc_payment_gateway_coinbase_icon', 'https://upload.wikimedia.org/wikipedia/commons/1/1a/Coinbase.svg');
    ...
    public function process_payment($order_id)
    {
        ...
        try {
            ...
            $body = [
                ...
                'redirect_url' => Growtype_Wc_Payment_Gateway::success_url($order_id),
