...
class Growtype_Wc_Payment_Gateway_Paypal_Hosted_Fields
{
    ...
    width: calc(100% + 12px);  */
            ...
            .gwc-hf-input:focus, .gwc-hf-frame.gwc-focused {
                border-color: #4f8ef7;
                box-shadow: 0 0 0 3px rgba(79, 142, 247, .15);
            }

            .gwc-hf-frame.gwc-valid {
                border-color: #4caf50;
            }

            .gwc-hf-frame.gwc-invalid {
                border-color: #e05c5c;
            }
            ...
            .gwc-hf-submit:hover:not(:disabled) {
                opacity: .92;
            }

            .gwc-hf-submit:active {
                transform: scale(.99);
            }

            .gwc-hf-submit:disabled {
                opacity: .5;
                cursor: not-allowed;
            }
