...
class Growtype_WC_Gateway_Cc extends WC_Payment_Gateway
{
    ...
    protected function setup_properties()
    {
        ...
        $this->chosen = false;
        $this->card_information_fields_orientation = apply_filters('growtype_wc_gateway_cc_card_information_fields_orientation', 'separated'); //combined
    }
    ...
    public function payment_fields()
    {
        ...
        $label = apply_filters('growtype_wc_gateway_cc_payment_button_label', __('Complete secure payment', 'growtype-wc'));
