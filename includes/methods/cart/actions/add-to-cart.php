 ...
 * Add to cart ajax
 */
add_filter('woocommerce_add_cart_item_data', 'growtype_wc_add_cart_item_data');
 ...
 * Added to cart ajax
 */
add_action('woocommerce_ajax_added_to_cart', 'growtype_wc_ajax_added_to_cart');
function growtype_wc_ajax_added_to_cart($product_id)
{
    global $woocommerce;
