 ...
 */
add_action('woocommerce_product_options_shipping_product_data', 'growtype_wc_product_options_shipping_product_data');
function growtype_wc_product_options_shipping_product_data()
{
     ...
     *
     */
    $field_options = array ('' => __('Select a country / region&hellip;', 'growtype-wc')) + WC()->countries->get_allowed_countries();
 ...
 * Save data
 */
add_action('woocommerce_admin_process_product_object', 'growtype_wc_admin_process_product_object_shipping');
function growtype_wc_admin_process_product_object_shipping($product)
{
    /**
     * Volume
     */
     ...
     * Documents
     */
    $downloads = Growtype_Wc_Product::prepare_shipping_documents(
