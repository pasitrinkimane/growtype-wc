 ...
 * Custom fields
 */
add_action('woocommerce_product_options_advanced', 'growtype_wc_product_options_advanced');
function growtype_wc_product_options_advanced()
{
 ...
 * Save data
 */
add_action('woocommerce_admin_process_product_object', 'growtype_wc_admin_process_product_object_advanced');
function growtype_wc_admin_process_product_object_advanced($product)
{
    /**
     * Add to cart button custom text
     */
