 ...
 */
add_action('woocommerce_product_options_inventory_product_data', 'growtype_wc_product_options_inventory_product_data');
function growtype_wc_product_options_inventory_product_data()
{
 ...
 * Save data
 */
add_action('woocommerce_admin_process_product_object', 'growtype_wc_admin_process_product_object_inventory');
function growtype_wc_admin_process_product_object_inventory($product)
{
    /**
     * Units
     */
