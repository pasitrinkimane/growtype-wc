 ...
 */
add_filter(
    "growtype_user_account_permalink",
    "growtypw_wc_growtype_user_account_permalink",
);
...
function growtype_wc_get_account_subpage_intro_details($subpage)
{
    $available_pages = [
        "orders" =>
            __("Orders", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Purchase history", "growtype-wc") .
            "</div>",
        "edit-account" =>
        ...
        "edit-address" =>
            ...
            ' <div class="e-subtitle">' .
            __("Adjust shipping and billing details", "growtype-wc") .
            "</div>",
        "auctions-endpoint" =>
            __("Auctions", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Adjust auctions settings", "growtype-wc") .
            "</div>",
        "purchased-products" =>
            __("Purchased products", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Your products", "growtype-wc") .
            "</div>",
        "uploaded-products" =>
            __("Uploaded products", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Your uploads", "growtype-wc") .
            "</div>",
        "subscriptions" =>
            __("Subscriptions", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Adjust subscriptions details", "growtype-wc") .
            "</div>",
        "manage-subscription" =>
            __("Manage Subscription", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Adjust subscription details", "growtype-wc") .
            "</div>",
        "downloads" =>
            __("Downloads", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Available to download products", "growtype-wc") .
            "</div>",
        "payment-methods" =>
            __("Payment methods", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Adjust payment methods", "growtype-wc") .
            "</div>",
        "customer-logout" =>
            __("Logout", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Sign out from system", "growtype-wc") .
            "</div>",
        "billing" =>
            __("Billing address", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Adjust billing address details", "growtype-wc") .
            "</div>",
        "shipping" =>
            __("Shipping address", "growtype-wc") .
            ' <div class="e-subtitle">' .
            __("Adjust shipping address details", "growtype-wc") .
            "</div>",
    ];
...
add_action(
    ...
    "growtype_wc_account_page_intro_block",
);
add_action(
...
add_action(
    "woocommerce_before_account_purchased_products",
    "growtype_wc_account_page_intro_block",
);
add_action(
    "woocommerce_before_account_uploaded_products",
    "growtype_wc_account_page_intro_block",
);
add_action(
    "woocommerce_before_account_subscriptions",
    "growtype_wc_account_page_intro_block",
);
add_action(
...
function growtype_wc_account_page_intro_block()
{
    ...
    if (
        $url_slug === "subscriptions" &&
        isset($_GET["action"]) &&
        $_GET["action"] === "manage"
    ) {
        $back_url = growtype_wc_get_account_subpage_url("subscriptions");
        $intro_details = growtype_wc_get_account_subpage_intro_details(
            "manage-subscription",
        );
    }
...
add_filter(
    ...
    "growtype_wc_woocommerce_account_extend_menu_items",
    20,
);
...
add_filter(
    "query_vars",
    "growtype_wc_woocommerce_account_extend_query_vars",
    0,
);
