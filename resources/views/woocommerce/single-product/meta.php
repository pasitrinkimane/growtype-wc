...
<div class="product_meta">
    ...
    <?php if (wc_product_sku_enabled() && ($product->get_sku() || $product->is_type('variable'))) : ?>
        ...
        <span class="sku_wrapper"><?php esc_html_e('SKU:',
                'growtype-wc'); ?> <span class="sku"><?php echo ($sku = $product->get_sku()) ? $sku : esc_html__('N/A',
                    'growtype-wc'); ?></span></span>
    ...
    <?php if (!empty($author_details)) { ?>
        <div class="cat-parent">
            <?php esc_html_e('Author', 'growtype-wc') ?>
        </div>
        <div class="cat-parent">
    ...
    foreach ($parents as $parent) {
        ...
        <div class="cat-parent"><?php echo $parent->name ?></div>
        <div class="cat-children">
            <?php foreach ($children as $key => $child) { ?>
                <span><?php echo $child->name ?><?php echo count($children) - 1 === $key ? '' : ',' ?></span>
            <?php } ?>
        </div>
