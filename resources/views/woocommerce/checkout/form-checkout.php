...
<form name="checkout" method="post" class="checkout woocommerce-checkout woocommerce-checkout-<?php echo get_theme_mod('woocommerce_checkout_style_select') ?>" action="<?php echo esc_url(wc_get_checkout_url()); ?>" enctype="multipart/form-data">
    ...
    <div class="col2-set">
        ...
        <div id="order_review" class="woocommerce-checkout-review-order background-<?php echo get_theme_mod('woocommerce_checkout_order_review_background', true) ? 'enabled' : 'disabled' ?>">
