...
foreach ( $items as $item_id => $item ) :
	...
	?>
	<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>" style="font-size: 14px;">
		<td class="td font-family text-align-left" style="vertical-align: middle; padding: 5px 16px; word-wrap:break-word;">
		...
		<td class="td font-family text-align-<?php echo esc_attr( $price_text_align ); ?>" style="padding: 5px 16px;vertical-align:middle;text-align:right;">
			<?php
	...
	if ( $show_purchase_note && $purchase_note ) {
		...
		<tr class="purchase-note">
			<td colspan="3" class="td font-family text-align-left" style="vertical-align: middle; padding: 16px; border-top: 1px solid #E5E7EB;">
				<div style="color: #374151; font-size: 14px; line-height: 1.6;">
					<b style="color: #111827; display: block; margin-bottom: 4px;"><?php esc_html_e( 'Purchase note:', 'growtype-wc' ); ?></b>
					<?php
