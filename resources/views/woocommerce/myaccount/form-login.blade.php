...
<div class="u-columns" id="customer_login">
    ...
    <div class="u-column1 col-12">
        ...
        <form class="woocommerce-form woocommerce-form-login login container-sm ps-4 pe-4 pb-4" method="post">
            ...
            <div class="mb-3">
                <label for="username">
                    <?php esc_html_e('Username or email address', 'growtype-wc'); ?> <span class="required">*</span>
                </label>
        ...
        <div class="text-center ps-4 pe-4 pb-4">
            <label><?php esc_html_e("Don't have an account?", 'growtype-wc'); ?></label>
            <a href="#register" class="e-switchform e-register"><?php esc_html_e("Create here", 'growtype-wc'); ?></a>
        </div>
    ...
    <div class="u-column2 col-12">
        ...
        <form method="post" class="woocommerce-form woocommerce-form-register register ps-4 pe-4" <?php do_action('woocommerce_register_form_tag'); ?> >
            ...
            <div class="mb-3">
                <label for="reg_email"><?php esc_html_e('Email address', 'growtype-wc'); ?>
                    &nbsp;<span class="required">*</span></label>
            ...
            <p><?php esc_html_e('A password will be sent to your email address.', 'growtype-wc'); ?></p>
        ...
        <div class="text-center p-4">
            <label><?php esc_html_e("Already have an account?", 'growtype-wc'); ?></label>
            <a href="#login" class="e-switchform e-login"><?php esc_html_e("Login here", 'growtype-wc'); ?></a>
        </div>
