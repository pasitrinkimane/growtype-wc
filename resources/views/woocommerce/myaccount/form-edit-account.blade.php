    ...
    <div class="main-fields">
        ...
        <div class="fields-group">
            ...
            <div class="row g-3 fields-group-fields">
                ...
                <div class="e-wrapper col-md-6">
                    <label for="account_display_name" class="form-label"><?php esc_html_e('Display name',
                            'growtype-wc'); ?>
                        <span class="required">*</span></label>
                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_display_name" id="account_display_name" value="<?php echo esc_attr($user->display_name); ?>"/>
                </div>

                <?php do_action('woocommerce_edit_account_form_account_details'); ?>
            </div>
        </div>
        ...
        <div class="fields-group">
            ...
            <div class="row g-3 fields-group-fields">
                ...
                <div class="e-wrapper col-md-6">
                    <label for="password_2" class="form-label"><?php esc_html_e('Confirm new password',
                            'growtype-wc'); ?></label>
                    <input type="password" class="woocommerce-Input woocommerce-Input--password input-text" name="password_2" id="password_2" autocomplete="off"/>
                </div>

                <?php do_action('woocommerce_edit_account_form_password_details'); ?>
            </div>
        </div>
    ...
    <div class="row row-submit mt-4 pt-3 pb-5 mb-4">
        <div class="d-grid gap-2 d-md-flex">
            ...
            <button type="submit" class="woocommerce-Button button btn btn-primary" name="save_account_details" value="<?php esc_attr_e('Save changes',
                'growtype-wc'); ?>"><?php esc_html_e('Save changes', 'growtype-wc'); ?></button>
