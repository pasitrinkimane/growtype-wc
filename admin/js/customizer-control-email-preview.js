...
wp.customize('woocommerce_email_page_template', function (value) {
    value.bind(function (newval) {
        ...
        if (newval.length > 0) {
            wp.customize.previewer.previewUrl(window.location.origin + '/growtype-wc/documentation/examples/email/preview?action=preview_email&email_type=' + newval + '&order_id=' + window.preview_order_id);
